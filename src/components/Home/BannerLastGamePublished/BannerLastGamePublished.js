...
export function BannerLastGamePublished() {
  ...
  // Todo: Pinta si hay info
  if (!game) return null;

  const wallpaper = game.attributes.walpaper; // TODO: Corregir l faltante.
  ...
  return (
    <div className={styles.container}>
      <Image src={`http://localhost:1337${wallpaper.data.attributes.url}`} className={styles.wallpaper} />
